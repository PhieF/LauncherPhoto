...
public class BubbleManager {
    ...
    public BubbleManager(WindowManager windowManager, Context context, BubbleLayout bubble){
        ...
        if(Build.VERSION.SDK_INT>Build.VERSION_CODES.O){
            paramsF.type=WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY;
        }else paramsF.type=WindowManager.LayoutParams.TYPE_PHONE;
    ...
    public void putNearestBoarder() {
        ...
        Log.d("posdebug","newX "+mBubble.getMainView().getMeasuredWidth());
